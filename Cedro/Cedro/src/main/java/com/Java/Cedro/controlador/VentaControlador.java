...
import com.Java.Cedro.servicio.Programacion_instalacionServicio;
...
public class VentaControlador {
	...
	@Autowired
	private Programacion_instalacionServicio Pservicio;
	...
	public String mostrarFormularioDeRegistrtarVenta(Model modelo) {
		...
		List<Programacion_instalaciones> lstP = Pservicio.listarTodosLasP();
